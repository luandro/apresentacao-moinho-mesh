...
const darkComponents = {
  ...
  h3: ({ children }) => <Heading size={3} textColor={theme.screen.colors.primary}>{children}</Heading>,
  h4: ({ children }) => <Heading size={4} textColor={theme.screen.colors.primary}>{children}</Heading>,
  h5: ({ children }) => <Heading size={5} textColor={theme.screen.colors.primary}>{children}</Heading>,
  h6: ({ children }) => <Heading size={6} textColor={theme.screen.colors.primary}>{children}</Heading>,
  p: ({ children }) => <Text textColor={theme.screen.colors.primary}>{children}</Text>
}
